package ru.mirea.kharakhorinvd.audiorecord;
...
import ru.mirea.kharakhorinvd.audiorecord.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private	void startRecording()	{
        ...
        Toast toast = Toast.makeText(context, "начало записи", duration);
        toast.show();
    ...
    private	void stopRecording() {
        if (recorder != null) {
            Context context = getApplicationContext();
            int duration = Toast.LENGTH_SHORT;
            Toast toast = Toast.makeText(context, "завершение записи", duration);
            toast.show();
            recorder.stop();
            recorder.release();
            recorder = null;
    ...
    private	void startPlaying() {
        ...
        try {
            ...
            Context context = getApplicationContext();
            int duration = Toast.LENGTH_SHORT;
            Toast toast = Toast.makeText(context, "проигрывание записи", duration);
            toast.show();
            player.start();
        } catch (IOException e) {
            Log.e(TAG,"prepare() failed");
    ...
    private	void stopPlaying() {
        if (player != null) {
            Context context = getApplicationContext();
            int duration = Toast.LENGTH_SHORT;
            Toast toast = Toast.makeText(context, "стоп проигрыванию записи.", duration);
            toast.show();
            player.release();
            player = null;
        }
